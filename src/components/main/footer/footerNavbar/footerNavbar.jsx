...
export const FooterNavbar = () => (
  <div className={cx('footer-navbar')}>
    <NavLink to={'/about'} className={cx('footer-nav-link')} activeClassName={cx('active')} >
      <FormattedMessage id={'FooterNavbar.about'} defaultMessage={'About casino'} />
    </NavLink>
    <NavLink to={'/terms'} className={cx('footer-nav-link')} activeClassName={cx('active')} >
      <FormattedMessage id={'FooterNavbar.terms'} defaultMessage={'Terms and conditions'} />
    </NavLink>
    <NavLink to={'/responsible-gaming'} className={cx('footer-nav-link')} activeClassName={cx('active')} >
      <FormattedMessage id={'FooterNavbar.responsible-gaming'} defaultMessage={'Responsible gaming'} />
    </NavLink>
    <NavLink to={'/contacts'} className={cx('footer-nav-link')} activeClassName={cx('active')} >
